...
export default function App() {
  ...
  md:justify-center md:h-screen md:max-w-2xl 
  md:mx-auto">
    <section className="md:flex bg-white shadow rounded-3xl">
    <div className="bg-div p-8 md:pt-10 text-center text-white 
    rounded-b-3xl md:flex-1 md:rounded-3xl md:flex md:flex-col 
    md:items-center md:justify-center">
      <p className="mb-6">Your Result</p>

     <div className="flex items-center justify-center">
      <p className="bg-circle w-24 h-24 md:w-40 md:h-40 flex flex-col items-center 
      justify-center gap-1 rounded-full text-white text-3xl md:text-6xl font-bold">
        76 
      ...
      <div className="flex flex-col gap-4">
        {items.map((item, index) =>(
          <div 
            ...
            className="flex item-center justify-between p-4 rounded lg"
         >
            <h3
              style={{
                Color: item.color,
            ...
            <p className="flex item-center gap-2 text-slate-500">
